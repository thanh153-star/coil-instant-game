...
var Coil = (function(){
	...
	// Cờ nếu trò chơi nên xuất thông tin gỡ lỗi
	...
	// Số lượng kẻ thù có thể tồn tại cùng một lúc,
	// thang đo này tùy thuộc vào độ khó
	var ENEMY_COUNT = 2;
		ENEMY_SIZE = 10;
	
	// The height of the header / status bar
	// Chiều cao của thanh tiêu đề / trạng thái
	...
	// Các trạng thái trò chơi được áp dụng cho cơ thể để các yếu tố có thể được
	// bật tắt khi cần trong CSS
	...
	// Ghi điểm mặc định (chúng có thể mở rộng tùy theo độ khó)
	...
	// Hệ số điểm tối đa có thể đạt được
	var MULTIPLIER_LIMIT = 4;
	
	// The maximum number of simultaneous effects to run
	// Số lượng hiệu ứng đồng thời tối đa để chạy
	...
	var mouse = {
		...
		// Vận tốc, dựa trên sự khác biệt giữa
		// vị trí hiện tại và tiếp theo
		velocityX: 0,
		velocityY: 0,
		
		// Flags if the mouse is currently pressed down
		// Cờ nếu chuột hiện đang được nhấn xuống
		down: false
	};
